...
\filldraw[fill=gray!30,draw=black,align=center] (0,0) node {$p(z)$ \\bounded} circle (1.5cm);
...
\begin{scope}[shift={(7,0)}]
	\draw (3.2, 3.2) -- (-3.2, 3.2) -- (-3.2, -3.2) -- (3.2, -3.2) -- cycle;
	\filldraw[fill=gray!30,draw=black,align=center] (0,0) node {$f(z)=\frac{1}{p(z)}$ \\still bounded} circle (1.5cm);
